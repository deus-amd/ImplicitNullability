...
namespace ImplicitNullability.Samples.Consumer.NullabilityAnalysis
{
    ...
    public class FieldsSampleTests
    {
        ...
        public void PublicFieldsAccess()
        {
            ...
            TestValueAnalysis(f.Field, f.Field == null /*Expect:ConditionIsAlwaysTrueOrFalse[Flds]*/);
        ...
        {
            // Here the implicit NotNull is potentially wrong:
            TestValueAnalysis(SF.Field, SF.Field == null /*Expect:ConditionIsAlwaysTrueOrFalse[Flds]*/);
        ...
        public void MutableClassWithImplicitNotNull()
        {
            ...
            TestValueAnalysis(mutableClass.Field, mutableClass.Field == null /*Expect:ConditionIsAlwaysTrueOrFalse[Flds]*/);
        ...
        {
            var mutableClass = new FieldsSample.MutableClass {Field = null /*Expect:AssignNullToNotNullAttribute[Flds]*/};
